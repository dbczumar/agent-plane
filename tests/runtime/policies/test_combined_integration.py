...
- LabelPolicy and FunctionPolicy composition on the same
...
async def test_web_search_first_call_taints_and_allows(
    ...
    """First web_search: LabelPolicy taints integrity AND
    ...
    # Verify persistence round-trip — the LabelPolicy's
...
async def test_web_search_over_budget_asks(
    ...
    FunctionPolicy's ASK wins because LabelPolicy returned
