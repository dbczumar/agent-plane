...
Load-bearing: the omniagents parity promise is that the
...
class _Harness:
    ...
    async def park(self, call_id: str, timeout_s: int) -> str:
...
async def _drive_ask(
    ...
    """Evaluate, assert ASK, drive approval with *verdict*."""
