"""Tests for agent_plane.onboarding.providers — catalog loading and queries."""
...
def test_get_all_providers_popular_first() -> None:
    ...
    from agent_plane.onboarding.providers import COMMON_PROVIDERS
...
def test_get_chat_models_sorted_newest_first() -> None:
    ...
    from agent_plane.onboarding.providers import _extract_model_version
