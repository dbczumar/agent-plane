...
def onboarding_agent_dir() -> Path:
    ...
    :returns: Absolute path to ``agent_plane/onboarding/agent/``.
    """
    return Path(__file__).parent.parent.parent / "agent_plane" / "onboarding" / "agent"
...
def test_onboarding_agent_has_expected_skills(
    ...
    # These are the three skills defined in the design doc.
    assert skill_names == [
