...
:func:`agent_plane_client.tools.build_tool_handler`.
...
event loop (``ap chat`` TUI) froze for the duration.
...
import pytest
from agent_plane_client._tool_handler import ToolCallInfo
