...
def upgrade() -> None:
    ...
    op.create_index('ix_conversation_items_conversation_id_position', 'conversation_items', ['conversation_id', 'position'], unique=False)
    op.create_index('ix_conversation_items_response_id', 'conversation_items', ['response_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('ix_conversation_items_conversation_id_position', table_name='conversation_items')
